...
class TestParlessCardsService {
    ...
    void givenMaxNumberOfCards_returnParlessCardsResponse() {
        when(cardRepository.findByParIsNullAndLastReadDateBeforeAndCircuitNotOrParIsNullAndLastReadDateIsNullAndCircuitNot(any(), any(), any(), any())).thenReturn(testBeans.TKM_CARD_LIST);
